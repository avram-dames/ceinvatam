...
function onSubmit() {
  ...
  sliderAlertMessage.value =
    props.sliderValue < 1 ? "Scorul trebuie să fie mai mare decât zero." : "";
...
<template>
  <div class="px-4">
    <h1>Spune-ne ce crezi despre {{ partnerName }}</h1>

    <h3 class="text-xl mt-10">Cum evaluezi servicile lor?</h3>
    <!-- slider -->
